                ...
                <form action="{{ route('products.update', $product->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="pt-3">
                        ...
                        <div class="mb-3">
                            ...
                            <x-text-input type="text" name="price" class="mt-1 block w-full" placeholder="Price" value="{{ $product->price }}" />
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <x-text-input class="mt-1 block w-full" name="description" placeholder="Food Description" value="{{ $product->description }}"/>
                        </div>
                        <div class="">
